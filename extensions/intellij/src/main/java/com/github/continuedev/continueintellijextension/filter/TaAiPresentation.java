...
public class TaAiPresentation implements EditorCustomElementRenderer, InputHandler {
    ...
    public int calcWidthInPixels(@NotNull Inlay inlay) {
        return IconLoader.getIcon("/icons/ta3logo_ex.svg", TaAiPresentation.class).getIconWidth() + 5;
    }
...
//        Icon consoleIcon = IconLoader.getIcon("/icons/ta3logo_ex.svg", TaAiPresentation.class);
//        int curX = r.x + r.width / 2 - consoleIcon.getIconWidth() / 2 + 5;
