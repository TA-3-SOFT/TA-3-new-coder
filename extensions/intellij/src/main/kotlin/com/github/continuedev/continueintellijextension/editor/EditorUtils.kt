...
class EditorUtils(val editor: Editor) {
    ...
    /**
     * Reads the entire file content and prepends line numbers to each line.
     * Returns a string where each line is formatted as "lineNumber: lineContent".
     * Returns null if the document cannot be accessed.
     */
    fun readFileWithLineNumbers(): String? {
